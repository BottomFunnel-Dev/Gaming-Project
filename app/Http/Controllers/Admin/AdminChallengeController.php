...
class AdminChallengeController extends Controller
{
    ...
    public function ApiResult($resultowner){
        ...
        }elseif($resultowner == "result-vanished"){
            return '<span style="color:red;font-weight:900;">result-vanished</span>';
        }else{
            return '<span style="color:red;font-weight:900;">'.$resultowner.'</span>';
        }
    }
