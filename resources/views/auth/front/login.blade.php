            ...
            <div class="main-area">
               ...
               <div class="position-absolute w-100 center-xy mx-auto sign-otp">
                  ...
                  <div class="bg-white cxy flex-column">
                     ...
                     <input class="form-control" id="mobile-no" name="mobile" type="tel" placeholder="Mobile number" value="">
                  ...
                  <div class="input-group pt-2" id="verify-otp-div" style="display:none">
                     ...
                     <input class="form-control" id="verify-otp" name="otp" type="tel" placeholder="Enter OTP" autocomplete="off" value="">
                     </div></div>
                     <input type="submit" value="Submit" class="submit-signup" /></div>



               </form>
			   <p></p><p style="color:white;margin-left:50px;margin-right:30px">By proceeding, you agree to our <a href="{{ route('front.terms-and-conditions') }}">Terms of Use</a>, <a href="{{ route('front.privacy-policy') }}">Privacy Policy</a> and that you are 18 years or older. You are not playing from Assam, Odisha, Nagaland, Sikkim, Meghalaya, Andhra Pradesh, or Telangana.</p>
			   </div>
		...
		$('#login-form').submit(function(e)
		  {
			...
			if(!mobile){
				...
				hideSuccessErrorDiv('alert-success','alert-danger','Please enter 10 digit mobile number');
				flag = 0;
			}
				...
				$form = $(this);
				 ...
				 $.ajax({
					...
					success:function(data){
						console.log(data);
						if(data.status == 1 ){
							hideSuccessErrorDiv('alert-danger','alert-success',data.message);
							$('#verify-otp').val('');
							$('#verify-otp-div').show();
				   ...
				   error:function(data){
					console.log(data);
						...
						hideSuccessErrorDiv('alert-success','alert-danger',data.responseJSON.message);
						$('#verify-otp').val('');
				   },
