...
<div class="main-area" style="padding-top: 60px;">
              ...
              <section class="footer">
                 ...
                 <div class="px-3 py-4">
                    ...
                    <br>
                    <div class="footer-text">AK Players is a real-money gaming product owned and operated by  ("AK Players" or "We" or "Us" or "Our").</div>
                    <br>
                    ...
                    <br>
                    <div class="footer-text">AK Players has a wide-variety of high-quality, premium HTML5 games. Our games are especially compressed and optimised to work on low-end devices, uncommon browsers, and patchy internet speeds.</div>
                    <br>
