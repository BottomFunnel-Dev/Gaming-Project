...
@section('content')
    @push('head')
        ...
        <style>
            /* Custom styles to make the table scrollable on mobile devices */
                    ...
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item pull-left">
                                <a href="javascript:void(0)" onclick="exportData()"><i class="ik ik-download"></i>Download
                                    in excel</a>
                            </li>
                        </ol>
                    </nav>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive"> <!-- Wrapper to make table scrollable -->
                                            ...
                                            <td>
                                                @can('manage_users')
                                                    <a title="View Statement" href="{{ url('admin/user/statement/' . $val->id) }}">
                                                        <i class="ik ik-eye f-16 ml-10 text-blue"></i>
                                                    </a>
                                                    <a title="Update user record" href="{{ url('admin/user/edit/' . $val->id) }}">
                                                        <i class="ik ik-edit-2 f-16 ml-10 text-green"></i>
                                                    </a>
                                                    @php
                                                        ...
                                                        if (
                                                            ...
                                                            $sHtml = '<a title="Make User Inactive" href="' . url('admin/user/status/0/' . $val->id) . '">
                                                                        <i class="ik ik-x f-16 ml-10 text-yellow"></i>
                                                                      </a>';
                                                        } else {
                                                            $sHtml = '<a title="Make User Active" href="' . url('admin/user/status/1/' . $val->id) . '">
                                                                        <i class="ik ik-check f-16 ml-10 text-blue"></i>
                                                                      </a>';
                                                        }
                                                        echo $sHtml;
                                                    @endphp
                                                    <a title="Update wallet balance" href="{{ url('admin/user/wallet/' . $val->id) }}">
                                                        <i class="ik ik-dollar-sign f-16 ml-10 text-red"></i>
                                                    </a>
                                                @endcan
                                            </td>
                                        </tr>
