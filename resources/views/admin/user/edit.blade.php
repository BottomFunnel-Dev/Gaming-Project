                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value="{{ $user->username }}" placeholder="Enter user name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mobile" maxlength="10" type="text"
                                            ...
                                            value="{{ $user->mobile }}" placeholder="Enter mobile no" required>
                                        <div class="help-block with-errors"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="referral" maxlength="10" type="text"
                                            class="form-control @error('referral') is-invalid @enderror" name="referral"
                                            value="{{ isset($user->setting->used_referral) ? $user->setting->used_referral : '' }}"
