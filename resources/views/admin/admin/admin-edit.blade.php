    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Edit Admin')}}</h5>
                            <span>{{ __('Edit admin details')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ url('admin/admin/update') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mobile_no" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ clean($user->mobile_no, 'titles')}}" placeholder="Enter mobile no" required>
                                        <div class="help-block with-errors" ></div>
                                    ...
                                    <div class="form-group">
                                        <img src="https://aayushi-bucket.s3.ap-south-1.amazonaws.com/images/{{$user->profile_pic}}" width="300px" height="200px" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('role', $roles, $user_role->id??'' ,[ 'class'=>'form-control select2', 'placeholder' => 'Select Role','id'=> 'role','disabled' => 'disabled', 'required'=>'required']) !!}
                                    </div>
                                    <div class="form-group">
