        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('create-admin') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="" placeholder="Enter admin name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mobile_no" maxlength="10" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ old('mobile_no') }}" placeholder="Enter mobile no" required>
                                        <div class="help-block with-errors" ></div>
