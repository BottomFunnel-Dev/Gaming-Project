        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 p-3">
                                {{ __('For user management: permission and roles we use') }}
                                <code>larave-permissions</code>
                                {{ __('packge. This package allows for users to be associated with permissions and roles. Every role is associated with multiple permissions. A ') }}
                                <code>Role</code> {{ __('and a') }} <code>Permission</code>
                                {{ __('are regular Eloquent models.') }} <br><br>

                                {{ __('Blade directive use:') }} <br>
                                <img src="{{ asset('img/blade-syntax.JPG') }}" alt="" class="img-fluid"> <br><br>
                                {{ __('Read larave-permissions') }} <a class="text-red"
                                    href="https://docs.spatie.be/laravel-permission/v3/introduction/">
                                    {{ __('documentation') }} </a>.
                            </div>
                        </div>
                ...
                <div class="card new-cust-card">
                    ...
                    <div class="card-block">
                        <div class="align-middle mb-25">
                            <img src="{{ asset('img/users/1.jpg') }}" alt="user image"
                        ...
                        <div class="align-middle mb-25">
                            <img src="{{ asset('img/users/2.jpg') }}" alt="user image"
                                class="rounded-circle img-40 align-top mr-15">
                            <div class="d-inline-block">
                                <a href="#!">
                                    <h6>{{ __('John Doue') }} </h6>
                        ...
                        <div class="align-middle mb-25">
                            <img src="{{ asset('img/users/3.jpg') }}" alt="user image"
                                class="rounded-circle img-40 align-top mr-15">
                            <div class="d-inline-block">
                                <a href="#!">
                                    <h6>{{ __('Alex Thompson') }} </h6>
                        ...
                        <div class="align-middle mb-25">
                            <img src="{{ asset('img/users/4.jpg') }}" alt="user image"
                                class="rounded-circle img-40 align-top mr-15">
                            <div class="d-inline-block">
                                <a href="#!">
                                    <h6>{{ __('John Doue') }}</h6>
            ...
            <div class="col-xl-8 col-md-6">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Edit permission will visible only for') }} <code>Super Admin</code>
                            {{ __('role and') }} <code>manage_sales</code> {{ __('permission') }}</p>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ __('Iphone 6') }}</td>
                                        <td><img src="{{ asset('img/widget/p2.jpg') }}" alt=""
                                    ...
                                    <tr>
                                        <td>{{ __('Jacket') }}</td>
                                        <td><img src="{{ asset('img/widget/p3.jpg') }}" alt=""
                                                class="img-fluid img-20"></td>
                                        <td>
                                            <div class="p-status bg-green"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>{{ __('Sofa') }}</td>
                                        <td><img src="{{ asset('img/widget/p4.jpg') }}" alt=""
                                                class="img-fluid img-20"></td>
                                        <td>
                                            <div class="p-status bg-green"></div>
                                        </td>
            ...
            <div class="col-xl-6 col-md-6">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Members performance will visible only for') }} <code>Super
                                Admin</code> {{ __('role and') }} <code>manage_projects</code> {{ __('permission') }}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
                            <div class="table-responsive">
                                <table class="table table-hover mb-0 without-header">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <h6 class="fw-700">$78.001<i class="fas fa-level-down-alt text-red ml-10"></i>
                                                </h6>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <h6 class="fw-700">$89.051<i class="fas fa-level-up-alt text-green ml-10"></i>
                                                </h6>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="scroll-widget">
                            <div class="latest-update-box">
                                ...
                                <div class="row pb-30">
                                    ...
                                    <div class="col pl-5">
                                        <a href="#!">
                                            <h6>{{ __('You have 3 pending Task.') }}</h6>
                                        </a>
                        ...
                        <div class="scroll-widget">
                            <div class="latest-update-box">
                                <div class="row pt-20 pb-30">
                                    ...
                                    <div class="col pl-5">
                                        <a href="#!">
                                            <h6>{{ __('Devlopment & Update') }}</h6>
                                        </a>
                                        <p class="text-muted mb-0">{{ __('Lorem ipsum dolor sit amet') }}, <a
                                                href="#!" class="text-blue"> {{ __('More') }}</a></p>
                                    </div>
                                </div>
                                <div class="row pb-30">
                                    <div class="col-auto text-right update-meta pr-0">
                                    ...
                                    <div class="col pl-5">
                                        ...
                                        <p class="text-muted mb-0">{{ __('Lorem dolor sit amet,') }} <a href="#!"
                                                class="text-blue"> {{ __('More') }}</a></p>
                                    </div>
                                </div>
                                <div class="row pb-30">
                                    <div class="col-auto text-right update-meta pr-0">
                                    ...
                                    <div class="col pl-5">
                                        ...
                                        <p class="text-muted mb-0">{{ __('Lorem ipsum dolor sit ipsum amet') }}, <a
                                                href="#!" class="text-green"> {{ __('More') }}</a></p>
                                    </div>
                                </div>
                                <div class="row pb-30">
                                    <div class="col-auto text-right update-meta pr-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col pl-5">
                                        ...
                                        <p class="text-muted mb-0">{{ __('Lorem ipsum dolor sit amet') }}, <a
                                                href="#!" class="text-red"> {{ __('More') }}</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Project task list will visible only for') }} <code>Super Admin</code>
                            {{ __('role and') }} <code>manage_projects</code> {{ __('permission') }}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                ...
                <div class="card feed-card">
                    ...
                    <div class="card-block">
                        <div class="row mb-30 align-items-center">
                            ...
                            <div class="col">
                                <a href="#!">
                                    <h6 class="mb-5">{{ __('You have 3 pending tasks.') }} <span
                                            class="text-muted float-right f-14">{{ __('Just Now') }}</span></h6>
                                </a>
                            </div>
                        </div>
                        <div class="row mb-30 align-items-center">
                            ...
                            <div class="col">
                                <a href="#!">
                                    <h6 class="mb-5">{{ __('New order received') }} <span
                                            class="text-muted float-right f-14">{{ __('Just Now') }}</span></h6>
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card">
                    ...
                    <div class="card-block widget-last-task">
                        ...
                        <p class="mb-10">{{ __('New Dashboard') }} <span
                                class="float-right text-muted f-14">{{ __('5 Mins ago') }}</span></p>
                        <ul class="list-unstyled mb-20">
                            <li class="d-inline-block"><img src="{{ asset('img/users/2.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                                    title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('img/users/3.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                                    title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('img/users/2.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                        ...
                        <p class="mb-10 ">{{ __('Web Design') }} <span
                                class="float-right text-muted f-14">{{ __('8 Mins ago') }}</span></p>
                        <ul class="list-unstyled  mb-20">
                            <li class="d-inline-block"><img src="{{ asset('img/users/2.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                                    title="Tooltip on top"></li>
                        ...
                        <p class="mb-10">{{ __('Android Design') }} <span
                                class="float-right text-muted f-14">{{ __('12 Mins ago') }}</span></p>
                        <ul class="list-unstyled mb-20">
                            <li class="d-inline-block"><img src="{{ asset('img/users/4.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                                    title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('img/users/2.jpg') }}" alt="user-image"
                                    class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top"
                        ...
                        <hr>
                        <p class="mb-0">{{ __('Add project button will visible only for') }} <code>Super Admin</code>
                            {{ __('role and') }} <code>manage_projects</code> {{ __('permission') }}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card testimonial-card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3">{{ __('Testimonial will visible only for') }} <code>Super Admin</code>
                            {{ __('role and') }} <code>manage_projects</code> {{ __('permission') }}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="mt-15 mb-0 text-muted">
                                            {{ __('Lorem Ipsum is simply dummy text of the printing and typesetting.') }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-auto pr-0">
            ...
            <div class="col-md-12">
                <div class="card table-card">
                    ...
                    <div class="card-block p-b-0">
                        <p class="mb-0 p-3">{{ __('Sales report will visible only for') }} <code>Super Admin</code>
                            {{ __('role and') }} <code>manage_sales</code> {{ __('permission') }}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_sales')
                            <div class="table-responsive">
                    ...
                    <p class="mb-0 p-3">{{ __('View all Sales url will visible only for') }} <code>Super Admin</code>
                        {{ __('role and') }} <code>manage_sales</code> {{ __('permission') }}</p>
                    <!--start permitted area for manage_sales permission -->
                    @can('manage_sales')
