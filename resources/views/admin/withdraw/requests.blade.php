                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($val->status == 'Unpaid')
                                                    <a href="{{ route('accept-request-mannual', $val->id) }}"
                                                        onclick="return confirm('Are you sure want to perform this action?')"
                                                        class="btn btn-primary mb-2 ">Accept Mannual</a>
                                                @else
                                            ...
                                            <td>
                                                @if ($val->status == 'Unpaid')
                                                    ...
                                                    <a href="{{ route('accept-request', $val->id) }}"
                                                        onclick="return confirm('Are you sure want to perform this action?')"
                                                        class="btn btn-success mb-2 ">Accept</a>
                                                    <a href="{{ route('decline-request', $val->id) }}"
                                                        onclick="return confirm('Are you sure want to perform this action?')"
                                                        class="btn btn-danger mb-2 ">Decline</a>
                                                @else
                                                    <a href="javascript:void;"
                                                        class="btn btn-primary mb-2 ">{{ $val->status }}</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
