            ...
            <div class="card-header">
                <h3 class="d-block w-100">
                    ...
                    @if ($challenge->status != 0)
                        <button onclick="calcelGame({{ $challenge->id }})" class="btn btn-danger mb-2 float-right">Cancel
                            Challenge</button>
                    @endif
                </h3>
            </div>
                    ...
                    @if (isset($challenge->usersresult))
                        @foreach ($challenge->usersresult as $kk => $vv)
                            @if ($vv->user_id == $challenge->c_id)
                                @php
                                    // Set the resultowner based on the creator's actual result
                                    $resultowner = $vv->result;
                                @endphp
                                <div class="col-sm-6 invoice-col">
                                    <h2>Creator Results
                                        @php
                                            ...
                                            } elseif ($resultowner == 'Cancel' && $resultplayer1 == 'Cancel') {
                                                echo '<span style="color:gray;font-weight:900;">Hold</span>';
                                            } else {
                            ...
                            @if ($vv->user_id == $challenge->o_id)
                                @php
                                    // Set the resultplayer1 based on the opponent's actual result
                                    $resultplayer1 = $vv->result;
                                @endphp
                                <div class="col-sm-6 invoice-col">
                                    <h2>Opponent Results
                                        @php
                                            if ($resultplayer1 == 'waiting') {
                                                echo '<span style="color:blue;font-weight:900;">Waiting</span>';
