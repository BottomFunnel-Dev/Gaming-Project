...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            @endif
            <div class="row">
                <span style="color:red"><b>Note : </b>कृपया अपनी सही Ludo King ID से ही ज्वाइन करे, जिसे अपने ज्वाइन करते
                    टाइम डाला था| </span>
                <div class="col-md-3">
                        ...
                        <tbody>
                            ...
                            @foreach ($players as $id => $val)
                                <tr>
                                    ...
                                    @if ($contest->status == 2 || $contest->status == 3)
                                        )<td>{{ @$val->table_no->table_no }}</td>
                                    @endif
                                </tr>
                            @endforeach
                            <?php if(empty($players)){ ?> <tr>
