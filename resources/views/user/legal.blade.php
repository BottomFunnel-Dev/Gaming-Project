...
<div class="main-area" style="padding-top: 80px;">
<div class="container d-flex flex-column align-items-stretch justify-content-start" style="text-align: left;">
<div class="accordion">
    <div class="accordion-item">
    <h2 class="accordion-header">
    <a href="{{URL('terms-and-conditions')}}">
        <button type="button"aria-expanded="false" class="accordion-button collapsed">Terms &amp; Conditions</button>
</a>
    ...
    <div class="accordion-item">
        ...
        <a href="{{URL('refund-and-cancellation-policy')}}">
            <button type="button" aria-expanded="false" class="accordion-button collapsed">Cancellation &amp; Refund Policy</button>
</a>
        </h2>
        <div class="accordion-collapse collapse">
            <div class="accordion-body"></div>
        ...
        <div class="w-100 accordion-item">
            ...
            <a href="{{URL('privacy-policy')}}">
                <button type="button" aria-expanded="false" class="accordion-button collapsed">Privacy Policy</button>
</a>
            </h2>
            <div class="accordion-collapse collapse"><div class="accordion-body"></div>
        </div></div>
        <div class="accordion-item">
            <h2 class="accordion-header">
            <a href="{{URL('terms-and-conditions')}}">
                <button type="button" aria-expanded="false" class="accordion-button collapsed">About Us</button>
</a>
            </h2>
            <div class="accordion-collapse collapse">
                <div class="accordion-body"></div>
            ...
            <div class="accordion-item">
                ...
                <a href="{{URL('contact-us')}}">
                    <button type="button" aria-expanded="false" class="accordion-button collapsed"><p>Contact us</p></button>
</a>
                </h2>
                <div class="accordion-collapse collapse">
                    <div class="accordion-body">
                        ...
                        <a href="#" target="_blank" rel="noreferrer">Live Chat Support</a></div>
                    </div></div></div></div>
...
.f {
    ...
    position: absolute;
    right: 0;
    -webkit-transform: translate3d(0,calc(var(--y)*-40%),0) scale(calc(1 - var(--y)*.05));
...
.challengeButton a.btn-secondary {
    color: #fff!important
}
...
.blinking-black {
    -webkit-animation: blinkingTextBlack 1.2s infinite;
...
.blinking-info {
    -webkit-animation: blinkingTextInfo 1.2s infinite;
    animation: blinkingTextInfo 1.2s infinite;
    color: #17a2b8;
    font-size: 25px
}

@-webkit-keyframes blinkingTextInfo {
    0% {
        color: #17a2b8
    }
