...
@section('content')
    <div class="main-area" style="padding-top: 60px;position:relative;">
        <div class="d-flex align-items-center px-4 py-3">
            ...
            <div class="games-section-title position-absolute" style="right: 1.5rem;"><img class="mr-1 mb-1"
                    src="{{ asset('front/images/global-rupeeIcon.png') }}" width="20px" alt="">₹<span
                    id="wallet-balance">{{ $winningAmount }}</span></div>
        </div>
        ...
        <div id="with_success"
            style="position:fixed;top: 0;left: 0;display: none;width: 100%;height: 100vh;background-color: #12c06a;z-index: 10;flex-direction: column;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center;">
                        ...
                        <div class="p-4 bg-light">
                            <div class="card text-center mt-3">
                                <div style="margin-bottom: 20px;">
                                    <img src="https://media.licdn.com/dms/image/C4E12AQHzghUKW-4h8g/article-cover_image-shrink_600_2000/0/1624299773515?e=2147483647&v=beta&t=w-mP80ouuXQ3dXqCZPN2z7dCB4uXTnBfKHacyRK2Ty8"
                                        alt="" width="50%" class="mt-4">
                                    <div class="ml-1 mt-2 mytext" style="color:red; font-weight:800">Complete KYC to take
                                        Withdrawals</div><br>
                    ...
                    @else
                        <div>Withdraw Amount &amp; TDS<div class="MuiFormControl-root MuiTextField-root mt-2 w-100">
                                <div
                                    ...
                                    <input aria-invalid="false" id="amount" placeholder="Enter Amount" type="tel"
                                        oninput="makeOnlyIntehger(this)"
                                        class="MuiInputBase-input MuiFilledInput-input MuiInputBase-inputAdornedStart MuiFilledInput-inputAdornedStart"
                                        value="" style="padding-top: 10px;">
                                </div>
                                <p class="MuiFormHelperText-root MuiFormHelperText-contained">Minimum: 300</p>
                            </div>
                        </div>
                        <p style="color:red;" id="withdraw_amount-error"></p>
                        <div class="mt-4">Select Withdrawal Modes<span class="ml-2">
                                <button onclick="location.href='/edit-bank'" class="btn btn-sm btn-danger ml-auto mr-2"
                                    style="z-index: 1;"><svg class="MuiSvgIcon-root mr-1 MuiSvgIcon-fontSizeSmall"
                            ...
                            <div class="mt-3">
                                @if ($ModeOn[0] == 'yes')
                                    <div class="mt-4" style="cursor:pointer;" onclick="SelectMode(this,'upi')">
                                        <div class="add-fund-box d-flex align-items-center"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-center flex-column ml-4">
                                                    ...
                                                    @if ($UPIbankDetail)
                                                        <div class="jss2" style="font-size: 0.7em;">UPI Id:
                                                            {{ $UPIbankDetail->number }}</div>
                                            ...
                                            <div class="ml-auto mr-4 text-primary option-tick" style="display:none;">
                                                <img src="https://khelbro.com/images/select-blue-checkIcon.png"
                                                    width="15px" alt="">
                                            </div>
                                            @if (!$UPIbankDetail)
                                                <div class="ml-auto mr-4 text-primary"
                                                    onclick="location.href='/editBankDeatil/upi'">Link</div>
                                            @endif
                                        </div>
                                    </div>
                                @endif
                                @if ($ModeOn[1] == 'yes')
                                    <div class="mt-4" style="cursor:pointer;" onclick="SelectMode(this,'imps')">
                                        <div class="add-fund-box d-flex align-items-center"
                                            style="padding-top: 15px; height: 80px;">
                                            <div class="d-flex align-items-center"><img width="48px"
                                                    src="/images/bank.png" alt="">
                                                <div class="d-flex justify-content-center flex-column ml-4">
                                                    <div class="jss1">Bank Transfer</div>
                                                    @if ($IMPSbankDetail)
                                                        <div class="jss2" style="font-size: 0.7em;">Bank Account:
                                                            {{ $IMPSbankDetail->number }}</div>
                                                        <div class="jss2" style="font-size: 0.7em;">IFSC Code:
                                                            {{ $IMPSbankDetail->ifsc }}</div>
                                                        <div class="jss2" style="font-size: 0.7em;">Verified Name:
                                            ...
                                            @if (!$IMPSbankDetail)
                                                <div class="ml-auto mr-4 text-primary"
                                                    onclick="location.href='/editBankDeatil/imps'">Link</div>
                                            @endif
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="refer-footer"><button type="button" id="SubmitWithdrawal"
                                class="refer-button cxy w-100 bg-primary">Withdraw</button>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div id="Loading_pp"
        style="display:none;position:fixed;width:100dvw;height:100dvh;top: 0;left: 0;z-index: 11111111;flex-direction: row;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center;background: #ffffff;color: white;">
        <h1 style="text-align:center;">
            <img style="width: 100%;"
                src="https://cdn.dribbble.com/users/274482/screenshots/4828558/media/774456fdd41fb9ae14ec16da5ccfef62.gif">
        </h1>
    </div>
    ...
    <script>
        ...
        function makeOnlyIntehger(a) {
            ...
            // Set the input value to the integer
            if (!isNaN(intValue)) {
                $('#amount').val(intValue);
            } else {
                $('#amount').val('');
