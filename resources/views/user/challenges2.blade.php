    ...
    <div class="main-area" style="padding-top: 70px;">
        ...
        <div class="px-4 py-3">
            <div class="mb-2"><img src="{{ asset('front/images/award-blue.png') }}" width="20px" alt=""><span
                ...
                <span class="games-section-headline text-uppercase position-relative mt-2 font-weight-bold float-right"
                    style="top: -0.2rem;">
                    <a href="{{ route('front.game-rules') }}">Rules <i class="fa fa-info-circle"
            ...
            <div class="divider-x"></div>
            <div class="mb-2">
                <img src="{{ asset('front/images/award-blue.png') }}" width="20px" alt=""><span
        ...
        <script>
            ...
            function playNotification() {
                var url = "https://d37om4gxfn0aox.cloudfront.net/static-content/front/sound/notification.mp3";
                const audio = new Audio(url);
                audio.play();
            }

            function playStart() {
                var url = "https://d37om4gxfn0aox.cloudfront.net/static-content/front/sound/start-game.mp3";
                const audio = new Audio(url);
                audio.play();
            }
            ...
            function listChallengeCre(data) {
                ...
                html += '<div>v/s</div></div><div class="text-center col-5"><div class="pl-2">';
                html += '<img class="border-50" id="' + data.id +
                    '-loading" src="{{ asset('front/images/small-loading.gif') }}" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName" id="' +
            ...
            function playingGameHtml(data) {
                ...
                html += '<div style="line-height: 1;"><span class="betCard-playerName">' + data.cname +
                    '</span></div></div><div class="pr-3 text-center col-2 cxy">';
                html += '<div>v/s</div></div><div class="text-center col-5">';
                html +=
                    '<div class="pl-2"><img class="border-50" src="{{ asset('front/images/author.svg') }}" width="21px" height="21px" alt=""></div>';
            ...
            function setMyPlayChallenges(myPlayChallenges) {
                ...
                for (let i = 0; i < myPlayChallenges.length; i++) {
                    ...
                    html += '<img class="mx-1" src="{{ asset('front/images/global-rupeeIcon.png') }}" width="21px" alt="">' +
                        prize + '</span><div class="betCard-title d-flex align-items-center text-uppercase">';
                    html += '<span class="ml-auto"><a href="https://akplayers.com/challenge-detail/' + myPlayChallenges[i].id +
