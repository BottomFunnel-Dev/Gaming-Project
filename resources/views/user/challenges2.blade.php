...
<script>
		...
		function playingGameHtml(data){
			var html	=	'';
			var prize	=	getPrizeAmount(data.amount);
			html	+='<div id="pp2"><div class="betCard mt-1" id="playing-chdiv-'+data.id+'"><div class="d-flex"><span class="betCard-title pl-3 d-flex align-items-center text-uppercase">PLAYING FOR';
